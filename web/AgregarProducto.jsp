                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group border-primary ">
                            <div class="form-group border-primary">
                                ...
                                <input type="text" name="txtNombre" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                                <label>Descripcion</label>
                                <input type="text" name="txtDescripcion" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                                <label>Precio</label>
                                <input type="number" name="txtPrecio" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                                <label>Stock</label>
                                <input type="number" name="txtStock" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                                <label>Imagen</label>
                                <input class="form-control border-primary" type="file" name="fileImagen">
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-white bg-dark mb-3 border-primary">
                        <button type="submit"  value="Guardar" name="accion" class="btn btn-primary  scroll-click" rel="content-y"  data-toggle="collapse"><i class="fa fa-floppy-o" aria-hidden="true"></i>Nuevo</button>
