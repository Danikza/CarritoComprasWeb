        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="Controlador?accion=Carrito"><i class="fa fa-shopping-cart" aria-hidden="true">(<label style="color:orange">${contador}</label>)</i>Carrito</a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                    ...
                    <div class="col-sm-4">
                        <div class="card border-success mb-3" style="max-width: 32rem;">
                            ...
                            <div class=" tex-center card-footer card text-white bg-dark border-succes border-primary">
                                ...
                                <div>
                                    <a href="Controlador?accion=AgregarCarrito&id=${p.getId()}" class="btn btn-primary">Agregar a carrito</a>
