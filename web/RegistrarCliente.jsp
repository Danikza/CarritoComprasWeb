                ...
                <div class="card container mt-4 border-primary" style="width: 50rem;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group border-primary">
                            <div class="form-group border-primary ">
                                <label>DNI</label>
                                <input type="text" name="txtDNI" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                                <label>Nombres</label>
                                <input type="text" name="txtNombres" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="txtDireccion" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                                <label>Correo</label>
                                <input type="text" name="txtCorreo" class="form-control border-primary">
                            </div>
                            <div class="form-group">
                                <label>Password</label>
                                <input type="text" name="txtPassword" class="form-control border-primary">
                            </div>
                        </div>
                    </div>
                    <div class="card-footer text-white bg-dark mb-3 border-primary">
                        <button type="submit"  value="Nuevo" name="accion" class="btn btn btn-primary" rel="content-y"  data-toggle="collapse"><i class="fa fa-floppy-o" aria-hidden="true"></i>Nuevo</button>
                        <a href="ControladorC?accion=index.jsp" class="btn btn-danger"><i class="fa fa-reply-all" aria-hidden="true"></i>Volver<a/>
                    </div>
                </div>
